...
static const _Connection_type_support_symbol_names_t _Connection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wireless_msgs, msg, Connection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wireless_msgs, msg, Connection)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wireless_msgs, msg, Connection)() {
  return &::wireless_msgs::msg::rosidl_typesupport_c::Connection_message_type_support_handle;
}
