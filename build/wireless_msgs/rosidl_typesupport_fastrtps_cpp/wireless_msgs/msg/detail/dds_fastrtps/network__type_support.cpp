...
#include "wireless_msgs/msg/detail/network__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const wireless_msgs::msg::Network & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  wireless_msgs::msg::Network & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
...
{
  auto typed_message =
    static_cast<const wireless_msgs::msg::Network *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wireless_msgs::msg::Network *>(
    untyped_ros_message);
...
{
  return &wireless_msgs::msg::typesupport_fastrtps_cpp::_Network__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wireless_msgs, msg, Network)() {
  return &wireless_msgs::msg::typesupport_fastrtps_cpp::_Network__handle;
}
