...
class Metaclass_Scan(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from wireless_msgs.msg import Network
...
class Scan(metaclass=Metaclass_Scan):
    ...
    _fields_and_field_types = {
        'networks': 'sequence<wireless_msgs/Network>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['wireless_msgs', 'msg'], 'Network')),  # noqa: E501
    )
